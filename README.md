...
|   +-- **game.h**: *The Game class consists of a renderer, controller and game componenets (snake and food). Controlls the game loop, updates food and snake, displays a menu when called, and optionally saves the game exit.*
